...
def endGame():
    print("HOLDER2")
    # if ending at beach, while loop to index a list of strings about what they see
    # if ending at cliffs, while loop to index a list of strings about what they see